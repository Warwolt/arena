...
#define Dict_contains(dict, key) Dict_contains_impl((dict)->indices, (dict)->keys, (key))
...
bool Dict_remove_impl(size_t elem_size, size_t* dict_indices, int* dict_keys, char* dict_values, size_t* dict_size, int key);
...
bool Dict_contains_impl(size_t* dict_indices, int* dict_keys, int key);
